...
\end{center}
    ...
    \resumeSubHeadingListStart
        \resumeSubItem{\textbf{Languages:} Go, Ruby, TypeScript, Java, Python}
        \resumeSubItem{\textbf{Tools/Frameworks:} Docker, Kubernetes, Redis, Memcached, PostgreSQL, NoSQL, Kafka, RabbitMQ, Jenkins, Prometheus, Grafana, React}
...
\section{Work Experience}
        ...
        \resumeItemListStart
            \resumeItem{Designed and implemented a scalable microservices-based architecture using Go, Ruby on Rails, and TypeScript to enhance logistics and inventory management systems, improving operational efficiency by 35\%.}
...
\section{Projects}
        ...
        \resumeProjectHeading
            {\textbf{Secure Microservices Architecture for E-commerce Platform} $|$ \emph{Go, Docker, Kubernetes, Kafka, Redis}}{Aug 2023 - Present}
            \resumeItemListStart
                \resumeItem{Designed and implemented a secure microservices architecture using Go, Docker, and Kubernetes to improve the scalability and reliability of an e-commerce platform.}
\resumeItem{Integrated Kafka for real-time data streaming and Redis for caching to enhance performance and reduce latency.}
            \resumeItemListEnd
        \resumeSubHeadingListEnd
